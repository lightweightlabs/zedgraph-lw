...
namespace ZedGraph
{
	...
	#region Fields
      ...
      /// <summary>
      /// protected field that stores a <see cref="Label" /> instance for this
      /// <see cref="CurveItem"/>, which is used for the secondary <see cref="Legend" />
      /// label.  Use the public
      /// property <see cref="SecondaryLabel"/> to access this value.
      /// </summary>
      internal Label _secondaryLabel;
		/// <summary>
...
*/
		...
		private void Init( string label )
		{
         ...
         _secondaryLabel = new Label(null, null);
			_isY2Axis = false;
			_isX2Axis = false;
			_isVisible = true;
		...
		public CurveItem( CurveItem rhs )
		{
         ...
         _secondaryLabel = rhs._secondaryLabel.Clone();
	...
	#region Serialization
		...
		protected CurveItem( SerializationInfo info, StreamingContext context )
		{
         ...
         _secondaryLabel = (Label)info.GetValue("secondaryLabel", typeof(Label));
		...
		public virtual void GetObjectData( SerializationInfo info, StreamingContext context )
		{
         ...
         info.AddValue("secondaryLabel", _label);
